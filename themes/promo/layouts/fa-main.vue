...
<template>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="25 -25 250 250">
            <defs>
                <linearGradient id="lgrad1" x1="100%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" style="stop-color:#ff40ff;stop-opacity:1.00" />
    ...
    <div class="yinyang left-50px">
        ...
        <div class="box bg-#e00000 z--1"></div>
        <div class="box bg-black left-100px"></div>
        <div class="brand">匡醍 好课</div>
    </div>

    <div class="abs text-5xl text-center w-full text-shadow-[1px_4px_4px_rgba(0,0,0,0.5)]">因子分析与机器学习策略</div>

    <div class="abs text-3xl top-50% left-30px">
        <div class="bg-green rounded-10px pl-20px pr-20px p-5px">第一，你爱学习</div>
    </div>
