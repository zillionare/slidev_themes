...
const pixabayApiKey = ((import.meta as any).env?.PIXABAY || (import.meta as any).env?.VITE_PIXABAY || '').trim()
...
const installment = computed(()=>{
    return $slidev.configs.installment || "系列文章名称，选填"
})
...
<template>
    <div class="slidev-layout cover">
        ...
        <div v-if="showFooter" class="footer">
            <div class="photo">
                <span>Photo by: {{ photoCreditText }}</span>
            </div>
        </div>
    </div>
</template>
